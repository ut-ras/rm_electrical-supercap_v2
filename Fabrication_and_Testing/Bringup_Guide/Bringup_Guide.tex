...
Being the components that power the rest of the system, the voltage regulators' proper function must be confirmed before other components can be connected to their outputs. It should be noted that this Chapter can be completed second instead of first in the case of shipping delays for the voltage regulator. Refer to Section \ref{voltagewithpcb} for testing before gate drivers and Section \ref{voltagenopcb} for if testing and integration must occur after the steps of Chapter \ref{drivers} are completed. 
\section{Required Components}
\begin{tabular}{|c|c|c|}
	\hline
	\textbf{Component Name} & \textbf{Component Number} & \textbf{Quantity} \\
	\hline
	Horizontal XT30 input connector& - & 2 \\
	\hline
	12V voltage regulator & P7812B-1000 & 1 \\
	\hline
	3V3 voltage regulator & P7803B-1000  & 1 \\
	\hline
\end{tabular}
...
\begin{tabular}{|c|c|c|}
	...
	\hline
	Bootstrap Diode & V1P22HM3\_A/H & 2 \\
	\hline
...
\begin{tabular}{|c|c|c|}
	...
	\textbf{Component Name} & \textbf{Component Number} & \textbf{Quantity} \\
	\hline
	Power Inductor (ETD44 Core) & - & 1 \\
	\hline
	Filter Inductor (ETD29 Core) & - & 1 \\
	\hline
	Filter Capacitor & GRM188R6YA106MA73D  & 4 \\
	\hline
	Filter Resistor & ERJ-H3QD3R30V & 1 \\
	\hline
	Current Sensor & ACS71240KEXBLT-010B3  & 1 \\
	\hline
\end{tabular}
\section{Separate DC Load}
If possible, try to gain access to an adjustable DC load (available in the EER 1.808 power lab). 
